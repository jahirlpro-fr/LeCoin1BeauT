    ...
    <section className="relative min-h-[600px] md:min-h-[700px] flex items-center overflow-hidden">
      ...
      <div className="container-luxury relative z-10 py-20">
        <div className="max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-noir/5 backdrop-blur-sm border border-noir/10 mb-8 animate-fade-in">
            <Sparkles className="h-4 w-4 text-gold" />
            <span className="text-sm font-medium">Collection Printemps 2026</span>
          </div>

          {/* Title */}
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl leading-tight mb-6 animate-slide-up">
            L'Élégance
            <br />
          ...
          {/* Subtitle */}
          <p className="text-lg md:text-xl text-foreground/80 mb-10 leading-relaxed max-w-2xl animate-slide-up" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            <Button size="lg" asChild className="bg-noir hover:bg-noir/90 text-creme gap-2 group">
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 mt-16 pt-8 border-t border-noir/10">
            <div>
